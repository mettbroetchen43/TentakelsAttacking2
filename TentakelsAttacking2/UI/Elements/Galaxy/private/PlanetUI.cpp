...
void PlanetUI::CheckAndUpdate(Vector2 const& mousePosition, AppContext const& appContext) {
...
void PlanetUI::Resize(Vector2 resolution, AppContext const& appContext) {
