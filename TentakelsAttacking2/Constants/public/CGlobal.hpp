...
struct CGlobal final {
	...
	// versions
	static inline std::string const languageVersion{ "v0.1.5.3" }; ///< contains the language version string
	...
	static inline std::string const gameVersion{ "v0.1.5" }; ///< current gameVersion string
