...
struct CGlobal final {
	...
	// versions
	static inline std::string const languageVersion{"v0.1.4.5"}; ///< contains the language version string
	static inline std::string const configVersion{ "v0.1.4.1" }; ///< contains the config version string
